...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    Post_Date: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    Read_Timing: Schema.Attribute.String;
...
export interface ApiInstagramDataInstagramData
  ...
  info: {
    displayName: 'InstagramData';
    pluralName: 'instagram-datas';
    singularName: 'instagram-data';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::instagram-data.instagram-data'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReviewdataReviewdata extends Struct.CollectionTypeSchema {
  collectionName: 'reviewdatas';
  info: {
    displayName: 'reviewdata';
    pluralName: 'reviewdatas';
    singularName: 'reviewdata';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    GoogleReviewsUrl: Schema.Attribute.String;
    Image_url: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reviewdata.reviewdata'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
